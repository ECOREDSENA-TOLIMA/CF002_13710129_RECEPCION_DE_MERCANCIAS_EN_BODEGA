export default {
  ...
  glosario: [
    ...
    },
    {
      termino: 'IVA',
      significado:
        'es el impuesto de valor agregado en Colombia, el cual está incluido en la gran mayoría de productos y servicios. ',
    },
    {
      termino: 'Logística',
      significado:
    ...
    },
    {
      termino: 'NIT',
      significado:
        'es el número de identificación único tributario, el cual es asignado para realizar el control y trazabilidad fiscal de las empresas y personas naturales en Colombia.',
    },
    {
